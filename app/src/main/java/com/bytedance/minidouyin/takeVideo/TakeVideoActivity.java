...
import com.bytedance.minidouyin.showVideo.VideoPlayActivity2;
import com.bytedance.minidouyin.utils.ResourceUtils;
import com.bytedance.minidouyin.utils.UriUtils;
...
import static com.bytedance.minidouyin.GateWay.REQUEST_EXTERNAL_CAMERA;
...
public class TakeVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_system).setOnClickListener(v -> {
            startActivity(new Intent(TakeVideoActivity.this, SystemcameraActivity.class));
        });
